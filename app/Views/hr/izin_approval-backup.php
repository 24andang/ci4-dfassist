            ...
            <?php else : ?>
                <tr>
                    ...
                    <td>
                        ...
                        <?php else : ?>
                            ッ <span class="fst-italic text-muted">Tunggu Approval</span>
                        <?php endif; ?>
                    </td>
                    <td>
                                ...
                                <form action="/hr/izin/create" method="post">
                                    ...
                                    <div class="form-row border-top border-muted form mt-3">
                                        ...
                                        <div class="form-group col-md-6" id="keterangan_waktu"> <!-- start_time -->
                                            ...
                                            <input type="text" class="form-control" name="keterangan_waktu" value="<?= $izin['izin_akhir'] ? date('d-m-Y', strtotime($izin['izin_awal'])) : ''; ?>" disabled>
                                        </div>
                                    </div>
                                    <div class="form-row border-top border-bottom border-muted form mt-3">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <?= $izin['approval1'] == 1 ? '<span style="color: green; font-weight:bold">✓</span>' : '<span style="color: red; font-weight:bold">✗</span>' ?> - <?= $izin['atasan']; ?>
                                        </div>
                                        <div class="form-group col-md-6">
